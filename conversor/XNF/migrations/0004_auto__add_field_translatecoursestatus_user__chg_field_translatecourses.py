...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TranslateCourseStatus.user'
        db.add_column(u'XNF_translatecoursestatus', 'user',
                      self.gf('django.db.models.fields.CharField')(default=u'leosamu', max_length=200),
                      keep_default=False)


        # Changing field 'TranslateCourseStatus.startDate'
        db.alter_column(u'XNF_translatecoursestatus', 'startDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'TranslateCourseStatus.user'
        db.delete_column(u'XNF_translatecoursestatus', 'user')
