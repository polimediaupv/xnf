...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alert.startDate'
        db.add_column(u'XNF_alert', 'startDate',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2015, 7, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alert.startDate'
        db.delete_column(u'XNF_alert', 'startDate')
